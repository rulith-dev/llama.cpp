...
- a disk tier under the server's prompt cache, independent of the in-memory one, read straight from the device rather than through the page cache, and usable whether or not the server drafts
