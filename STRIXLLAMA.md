...
This branch is `pwilkin/llama.cpp` at `f5daaa3` plus the Strix Llama patch set: 43 files (39 modified, 4 added) that make Qwen3.8-Flash-Next fast on one AMD Strix Halo machine (Ryzen AI Max+ 395, Radeon 8060S / gfx1151) on Windows, built with HIP against TheRock ROCm 10.1.
